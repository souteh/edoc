...
public class TypeDeContenuResource {
    ...
    /**
     * SEARCH  /_search/type-de-contenus?query=:query : search for the typeDeContenu corresponding
     * to the query.
     *
     * @param query the query of the typeDeContenu search
     * @return the result of the search
     */
    @GetMapping("/_search/type-de-contenus")
    @Timed
    public List<TypeDeContenuDTO> searchTypeDeContenus(@RequestParam String query) {
        log.debug("REST request to search TypeDeContenus for query {}", query);
        return typeDeContenuService.search(query);
    }
