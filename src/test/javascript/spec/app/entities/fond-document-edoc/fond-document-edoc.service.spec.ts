    ...
    describe('FondDocumentEdoc Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fond-documents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FondDocumentEdoc', () => {
                service.create(new FondDocumentEdoc(null)).subscribe(received => {
            ...
            it('should update a FondDocumentEdoc', () => {
                service.update(new FondDocumentEdoc(123)).subscribe(received => {
            ...
            it('should return a FondDocumentEdoc', () => {
            ...
            it('should return a list of FondDocumentEdoc', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FondDocumentEdoc(123)]);
            });
