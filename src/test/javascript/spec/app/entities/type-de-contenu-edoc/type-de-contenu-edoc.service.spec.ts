    ...
    describe('TypeDeContenuEdoc Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/type-de-contenus';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TypeDeContenuEdoc', () => {
                service.create(new TypeDeContenuEdoc(null)).subscribe(received => {
            ...
            it('should update a TypeDeContenuEdoc', () => {
                service.update(new TypeDeContenuEdoc(123)).subscribe(received => {
            ...
            it('should return a TypeDeContenuEdoc', () => {
            ...
            it('should return a list of TypeDeContenuEdoc', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TypeDeContenuEdoc(123)]);
            });
